...
[assembly: AssemblyCopyright("Copyright © eSymmetrix, Inc 2009")]
...
// Monitor changes to the thread speed sliders
[assembly: GTraceField(AttributeTargetTypes = "Gibraltar.GSharp.WorkerUI", AttributeTargetMembers = "m_WorkerThreadSpeed")]
...
[assembly: GTimer(AttributeTargetTypes = "*MainApp", AttributeTargetMembers = ".ctor", AttributeExclude = true)]
[assembly: GTimer(AttributeTargetMembers = "regex:(Main|WorkerThread)", AttributeExclude = true)]
// Exclude everything in this low-level class that's fast and called all the time
[assembly: GTimer(AttributeTargetTypes = "*VerticalProgressBar", AttributeExclude = true)]
